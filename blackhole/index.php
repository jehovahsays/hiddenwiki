...
// whitelist bots
if (preg_match("/(Bumble Bee|Twitterbot|aolbuild|baidu|bingbot|bingpreview|msnbot|duckduckgo|adsbot-google|googlebot|mediapartners-google|teoma|slurp|yandex)/i", $useragent)) {
